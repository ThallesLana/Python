...
de dado dela. Este tipo é inferido ao atribuírmos o valor à mesma.
...
numero = 42     # Exemplo de varíavel global
print(numero)
print(type(numero))
...
if numero > 10:
    novo = numero + 10  # A varíavel 'novo' está declarada localmente dentro do bloco do if. Portanto, é local
    print(novo)
