...
# Exemplo de função onde a passagem de parâmetro seja obrigatoria
...
# OBS:
# Se o usuário passar somente 1 argumento, este será atribuído ao parâmetro numero, e será calculado ao ² deste número;
# Se o usuário passar 2 argumentos, o primeiro será atribuído ao parâmetro numero e o segundo ao parâmetro potencia.
# Então será calculada a potência.
...
- Evita error com parâmetros incorretos;
