...
# Funções podem ter n parâmetros de entrada. Ou seja, podemos receber como entrada em uma função quantos parâmentros
...
print(nome_completo('Tom', "Brady"))

# A diferença entre Parâmetros e Argumentos

# Parâmetros são variáveis na definição de uma função;
...
print((nome_completo(nome='Tom', sobrenome='Brady')))
print((nome_completo(nome=nome, sobrenome=sobrenome)))
print(nome_completo(sobrenome='Mahomes', nome='Patrick'))
