...
1 - Veja que, dentro das nossas funções podemos utilizar funções;
...
# Em Python podemos inclusive criar varíaveis do tipo de uma função e executar está função através da variável
