...
2 - As tuplas são imutáveis: Isso significa que ao criar uma tuplas ela não muda. Tooda operação em uma tuplas
gera uma nova tupla.
...
# Isso por que trabalhar com elementos imutáveis trazem segurança para o código.
...
nova = tupla   # Na tupla não temos problema com Shallow Copy
