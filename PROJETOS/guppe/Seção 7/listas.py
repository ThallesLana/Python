...
Listas em Python funcionam como vetores/matrizes (arrays) em outras linguagens, com a diferença de serem DINÂMICO e
...
# Podemos facilmente ordenar uma lista utilizando sort

lista1.sort()
print(lista1)

# Podemos facilmente contar o número de ocorrências de um valor em uma lista utilizando count
...
# Ex  : lista1.append(12, 34, 56)   # Erro
...
# Podemos inserir um novo elemento na lista informanod a posição do índice
...
# Podemos contar os elementos da lista utilizando len
print(len(lista2))

# Podemos remover facilmente o último elemento de uma lista utilizando pop
print(lista5)
lista5.pop()
print(lista5)
...
# Podemos facilmente converter uma string para uma lista usando split
...
print(numeros.index(5))     # Retorna o índice do primeiro valor encontrado
...
print(lista[:2])     # Iniciando no índice 0, e pega até o índice 2 - 1

print(lista[:4])    # Iniciando no índice 0, e pega até o índice 4 - 1

print(lista[1:3])   # Iniciando no índice 1, e pega até o índice 3 - 1
...
print(lista[0::2])     # Iniciando no índice 0 e vai até o final de 2 em 2
...
# OBS: Se tivermos mais elementos para desempacotar do que varáveis para receber os valores, teremos ValueError
...
# independentes, ou seja, modificando uma lista, não afeta a outra. Isso em Python é chamada de Deep Copy
...
# a modificação em uma das listas, essa modificação se refletiu em amabas as listas, Isso é chamado de Shallow Copy
