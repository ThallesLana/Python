...
# OBS: Se o valor não for encontrado, será informado um KeyError. Nenhum valor é retornado
...
# Imagine que temos dois conjuntos: Um contendo estudantes de curso Python e um contendo estudantes do curso Java.
